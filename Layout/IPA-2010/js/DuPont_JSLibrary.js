...
function bindSectionControl(divID, sectionHeader, collapse) {
    ...
    jQuery('#fptwrapper' + divID).before('<div id="fptheader' + divID +
					...
					header + '<span style="float:right;padding-right:5px;"><img class="fptheaderimage" src="../../_catalogs/masterpage/CustomByFPT/img/' +
...
function fptsectioncontrol_showhide(divid, obj) {
    ...
    if (collapse) {
        try {
            ...
            //for Sharepoint 2013
            jQuery(obj).find('img[class="fptheaderimage"]')[0].src = '../../_catalogs/masterpage/CustomByFPT/img/more_arrow.png';
        } catch (err) { }
    } else {
        try {
            div.css('width', '0px');
            ...
            jQuery(obj).find('img[class="fptheaderimage"]')[0].src = '../../_catalogs/masterpage/CustomByFPT/img/less_arrow.png';
        } catch (err) { }
    }
}
